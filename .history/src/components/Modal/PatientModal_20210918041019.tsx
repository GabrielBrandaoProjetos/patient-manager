...
const PatientModal: React.ForwardRefRenderFunction<ModalHandles> = ({}, ref) => {
  ...
  if(patientDetails?.dob?.date){
    ...
    birthDate = format(parseJSON(patientDetails?.dob?.date), 'dd-MM-yyyy')
  }
              ...
              <div className={classes.paper}>
                ...
                <div className={classes.info}>
                  ...
                  <div className={classes.blockInfo}>
                    ...
                    <span className={classes.span}>Birth Date: {format(parseJSON(patientDetails?.dob?.date), 'dd-MM-yyyy')}</span>
