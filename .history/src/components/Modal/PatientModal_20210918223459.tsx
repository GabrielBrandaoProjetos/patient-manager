...
const PatientModal: React.ForwardRefRenderFunction<ModalHandles> = ({}, ref) => {
  ...
  const {patients, patientDetails: Patient, getPatientByID} = useTableContext()
                ...
                <div className={classes.info}>
                  ...
                  <div className={classes.blockInfo}>
                    ...
                    <span className={classes.span}>
                      Birth Date: {format(parseJSON(patientDetails?.dob?.date), 'dd-MM-yyyy')}
                    </span>
                  ...
                  {patientDetails.id?.value && (
                    <>
                      ...
                      <p>
                        To share: <Link to={patientDetails.id?.value}>http://localhost:3000/home/patient/{patientDetails.id?.value}</Link>
                      </p>
                    </>
                  )}
                </div>
