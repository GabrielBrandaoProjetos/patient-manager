...
export const Home = () => {
  ...
  const {patients, patientsFilteredByString, patientsFilteredByGender, loadingMore, filterByString, handlePatientDetails, getPatientByGender} = useTableContext()
  ...
  function handleSearchByGender(gender: string){
    ...
    <div className={classes.root}>
      ...
      <TableContainer component={Paper} className={classes.tableContainer}>
        <Table aria-label="simple table">
              ...
              <TableCell className={`${classes.cellGender} ${classes.cellHeader}`}>
                ...
                {showChooseGender && (
                  <div className={classes.chooseGender}>
                    <Button onClick={() => handleSearchByGender("male")}>Male</Button>
                    <Button onClick={() => handleSearchByGender("female")}>Female</Button>
                  </div>
                )}
              </TableCell>
          ...
          <TableBody>
            {patientsFilteredByGender.length > 0 ? (
              patientsFilteredByGender.map((patient: Patient) => (
          ...
          {patients.length > 0 && !loading && patientsFilteredByString.length === 0 && (
