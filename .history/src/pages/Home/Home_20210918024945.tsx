...
export const Home = () => {
  ...
  const {patients, isActiveFilter, loadingMore, filterByString, handlePatientDetails, getPatientByGender, handleIsActiveFilter, clearFilterByGender} = useTableContext()
