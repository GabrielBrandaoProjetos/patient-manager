...
export const Home = () => {
  ...
  const {patients, loadingMore, filterByString, handlePatientDetails, getPatientByGender} = useTableContext()
  ...
  function handleFliterByString(value: string) {  
    ...
    <div className={classes.root}>
      ...
      <FormControl className={classes.form} variant="outlined">
        ...
        <OutlinedInput
          ...
          type="search"
          onChange={(e) => handleFliterByString(e.target.value)}
          endAdornment={
              ...
              <TableCell className={`${classes.cellGender} ${classes.cellHeader}`}>
                ...
                {showChooseGender && (
                  <div className={classes.chooseGender}>
                    <Button onClick={() => handleFliterByGender("male")}>Male</Button>
                    <Button onClick={() => handleFliterByGender("female")}>Female</Button>
                  </div>
                )}
              </TableCell>
