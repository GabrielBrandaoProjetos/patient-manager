...
export const TableProvider: React.FC = ({children}) => {
  ...
  function getPatientByID(id: string){
    const result = patients.reduce((result, patient) => {
  ...
  return (
    <TableContext.Provider value={{patients, patientDetails, resultSearch, loadingMore, filterByString, handlePatientDetails}}>
      {children}
